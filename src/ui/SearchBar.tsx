  ...
  return (
    <div className="relative rounded-[0.8rem] focus-within:outline-[0.1rem] focus-within:outline-accent">
      <input
        ...
        className="border-secondary/20 border-[0.1rem] w-[16rem] md:w-[40rem] h-[4rem] px-[1.5rem] rounded-[0.8rem] opacity-70 focus:outline-[0.1rem] focus:outline-transparent"
      />
